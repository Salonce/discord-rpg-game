...
/*
    public static void addInventoryToDb(Snowflake snowflake){
        try (Connection conn = DriverManager.getConnection(connectionUrl, "root", "password1");
             PreparedStatement idExistsStatement = conn.prepareStatement(selectSingleSnowflake("inventory", snowflake));
             PreparedStatement insertValuesStatement = conn.prepareStatement(addInventoryString(snowflake));
             ResultSet resultSetId = idExistsStatement.executeQuery()){
    ...
    public static void addEquipmentToDb(Snowflake snowflake){
        try (Connection conn = DriverManager.getConnection(connectionUrl, "root", "password1");
             PreparedStatement idExistsStatement = conn.prepareStatement(selectSingleSnowflake("equipment", snowflake));
             PreparedStatement insertValuesStatement = conn.prepareStatement(addEquipmentString(snowflake));
             ResultSet resultSetId = idExistsStatement.executeQuery()){
    ...
    public static void addHealthToDb(Snowflake snowflake){
        try (Connection conn = DriverManager.getConnection(connectionUrl, "root", "password1");
             PreparedStatement idExistsStatement = conn.prepareStatement(selectSingleSnowflake("health", snowflake));
             PreparedStatement insertValuesStatement = conn.prepareStatement(addHealthString(snowflake));
             ResultSet resultSetId = idExistsStatement.executeQuery()){
